...
#region /*Hat. This code needs to be after the draw_self*/
if (hat_sprite > noone)
{
	draw_sprite_ext(hat_sprite, 0, x, y - 32, image_xscale, 1, 0, c_white, 1);
}
#endregion /*Hat. This code needs to be after the draw_self END*/
...
and(!key_right)
{
	if(place_meeting(x - 1, y, obj_slope))
	{
		hspeed -= 0.4;
		image_xscale =- 1;
		y -= 1;
